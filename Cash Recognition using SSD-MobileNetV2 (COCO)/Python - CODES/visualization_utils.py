...
def visualize_boxes_and_labels_on_image_array(
 ...
 ##################################################################################################################################################################################             
              # for displaying the identified object
              print('Object Detected ==>',class_name)
              # for counting the repeated class_names
              
              globals.temp1 = class_name
              if str(globals.temp1) == str(globals.temp2):
                globals.count +=1   
              else:
                globals.count = 0

              # printing the new value and old value with count 
              print('  -> Previous:',globals.temp2,' New:',globals.temp1,' & count = ',globals.count)
                       
              globals.temp2 = globals.temp1       
            else:
              class_name = 'N/A'
